  ...
  return (
    <div className="flex flex-row gap-4 p-4 border-b border-[#334155] bg-[#111827] items-center last:border-b-0">
      ...
      <div className="flex-1 min-w-0">
        ...
        <p className="text-xs text-gray-400 mb-2 truncate">Seller: {product.seller}</p>
        <div className="flex items-center gap-1 text-xs text-gray-300">
          <Star size={12} className="text-[#FF9900]" fill="currentColor" />
          <span className="text-[#FF9900] font-bold">{product.rating}</span>
          <span className="hidden sm:inline">({product.reviewCount.toLocaleString()} reviews)</span>
        </div>
      </div>
